...
class _BasketScreenState extends State<BasketScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<BasketProvider>(context, listen: false).fetchBasket(scaffoldKey);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final deliveryCharge = basketProvider.basketItems.length * deliveryChargePerItem;
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                       ...
                                       SizedBox(
                                        ...
                                        SizedBox(
                                          width: 120, // Fixed width for the entire quantity selector
                                          child: Row(
